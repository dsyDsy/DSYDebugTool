...
- (void)initializeContainer{
    self.normalLogArray = [NSMutableArray arrayWithCapacity:self.logCount + 50];
    self.rnLogArray = [NSMutableArray arrayWithCapacity:self.logCount + 50];
    self.webLogArray = [NSMutableArray arrayWithCapacity:self.logCount + 50];
}
...
- (void)addLog:(_OCLogModel *)log
{
    ...
    if (log.logType == CocoaDebugLogTypeNormal)
    {
        ...
        //normal
        if ([self.normalLogArray count] >= self.logCount) {
    ...
    {
        //rn
        if ([self.rnLogArray count] >= self.logCount) {
    ...
    {
        //web
        if ([self.webLogArray count] >= self.logCount) {
